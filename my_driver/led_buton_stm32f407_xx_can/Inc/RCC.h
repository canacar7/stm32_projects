...
#define RCC_GPIOA_CLK_DISBLE()				CLEAR_BIT(RCC -> AHB1ENR, RCC_AHB1ENR_GPIOAEN)
#define RCC_GPIOB_CLK_DISBLE()				CLEAR_BIT(RCC -> AHB1ENR, RCC_AHB1ENR_GPIOBEN)
#define RCC_GPIOC_CLK_DISBLE()				CLEAR_BIT(RCC -> AHB1ENR, RCC_AHB1ENR_GPIOCEN)
#define RCC_GPIOD_CLK_DISBLE()				CLEAR_BIT(RCC -> AHB1ENR, RCC_AHB1ENR_GPIODEN)
